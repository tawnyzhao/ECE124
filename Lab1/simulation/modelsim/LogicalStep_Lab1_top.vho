...
SIGNAL \inst4|OUT_4~combout\ : std_logic;
SIGNAL \inst4|OUT_3~combout\ : std_logic;
SIGNAL \inst4|OUT_2~combout\ : std_logic;
SIGNAL \inst6|auto_generated|counter_reg_bit\ : std_logic_vector(27 DOWNTO 0);
SIGNAL \inst4|ALT_INV_OUT_2~combout\ : std_logic;
...
\inst4|ALT_INV_OUT_2~combout\ <= NOT \inst4|OUT_2~combout\;
...
-- Equation(s):
-- \inst6|auto_generated|cmpr1|aneb_result_wire[0]~5_combout\ = (!\inst6|auto_generated|counter_reg_bit\(8) & (!\inst6|auto_generated|counter_reg_bit\(10) & (\inst6|auto_generated|counter_reg_bit\(11) & !\inst6|auto_generated|counter_reg_bit\(9))))
...
-- Equation(s):
-- \inst6|auto_generated|cmpr1|aneb_result_wire[0]~4_combout\ = (\inst6|auto_generated|cmpr1|aneb_result_wire[0]~3_combout\ & (\inst6|auto_generated|cmpr1|aneb_result_wire[0]~2_combout\ & (\inst6|auto_generated|cmpr1|aneb_result_wire[0]~1_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst6|auto_generated|cmpr1|aneb_result_wire[0]~3_combout\,
	datab => \inst6|auto_generated|cmpr1|aneb_result_wire[0]~2_combout\,
	datac => \inst6|auto_generated|cmpr1|aneb_result_wire[0]~1_combout\,
...
-- Equation(s):
-- \inst6|auto_generated|cmpr1|aneb_result_wire[0]~6_combout\ = (\inst6|auto_generated|counter_reg_bit\(5) & (\inst6|auto_generated|counter_reg_bit\(6) & (\inst6|auto_generated|counter_reg_bit\(4) & \inst6|auto_generated|counter_reg_bit\(7))))
...
PORT MAP (
	...
	datad => \inst6|auto_generated|counter_reg_bit\(7),
...
-- Equation(s):
-- \inst6|auto_generated|cmpr1|aneb_result_wire[0]~7_combout\ = (\inst6|auto_generated|counter_reg_bit\(0) & (\inst6|auto_generated|counter_reg_bit\(1) & (\inst6|auto_generated|counter_reg_bit\(3) & \inst6|auto_generated|counter_reg_bit\(2))))
...
PORT MAP (
	...
	datad => \inst6|auto_generated|counter_reg_bit\(2),
...
-- Equation(s):
-- \inst6|auto_generated|cmpr1|aneb_result_wire[0]~8_combout\ = (\inst6|auto_generated|cmpr1|aneb_result_wire[0]~6_combout\ & \inst6|auto_generated|cmpr1|aneb_result_wire[0]~7_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst6|auto_generated|cmpr1|aneb_result_wire[0]~6_combout\,
...
-- Equation(s):
-- \inst9~combout\ = (\inst6|auto_generated|counter_reg_bit\(27)) # (!\PB[1]~input_o\)
...
\inst4|OUT_4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|OUT_4~combout\ = \inst9~combout\ $ (\sw[1]~input_o\ $ (((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	combout => \inst4|OUT_4~combout\);

-- Location: LCCOMB_X16_Y7_N0
\inst4|OUT_3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|OUT_3~combout\ = \sw[1]~input_o\ $ (((\inst9~combout\) # ((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	datac => \PB[0]~input_o\,
	datad => \inst6|auto_generated|counter_reg_bit\(26),
	combout => \inst4|OUT_3~combout\);

-- Location: LCCOMB_X16_Y7_N18
\inst4|OUT_2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|OUT_2~combout\ = \sw[1]~input_o\ $ (((\inst9~combout\ & ((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\)))))
